...
My exploratory DIY approach above works for my particular setup but lacks
the robustness of fuses or other protections for making mistakes in wiring,
overloading the power, etc.  I tried one off-the-shelf WLED controller
...
WLED. They are in China but shipping is cheap ($7)  and pretty quick (about a week). They are 
also very good at support, generally responding to emaail within a day or so.

The unit is turnkey and a nice solution for 1-2 LED strips (daisy-chained).  It nicely
drives two of my LED strips this way, using a 12v/5A power supply..
.
It is also designed to control many types of LED strips, including dumb ones. I had
some questions about the device and Athom was very responsive and helpful via email.
